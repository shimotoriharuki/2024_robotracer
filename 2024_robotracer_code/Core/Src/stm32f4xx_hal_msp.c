...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(GPIOA, ADC1_IN0_SENSOR0_Pin|ADC1_IN1_SENSOR1_Pin|ADC1_IN2_SENSOR2_Pin|ADC1_IN3_SENSOR3_Pin
                          |ADC1_IN4_SENSOR_L_Pin|ADC1_IN5_SENSOR_R_Pin|ADC1_IN6_BATT_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB13     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, SPI2_MISO_GP_Pin|SPI2_MOSI_GP_Pin);

    HAL_GPIO_DeInit(SPI2_SCK_GP_GPIO_Port, SPI2_SCK_GP_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOC, TIM3_CH1_ENC2_Pin|TIM3_CH2_ENC2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, TIM4_CH1_ENC1_Pin|TIM4_CH2_ENC1_Pin);
