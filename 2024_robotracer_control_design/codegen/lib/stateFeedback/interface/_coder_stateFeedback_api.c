 ...
 * File: _coder_stateFeedback_api.c
 *
...
void stateFeedback_atexit(void)
{
  ...
  stateFeedback_xil_terminate();
  stateFeedback_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_stateFeedback_api.c
 *
 * [EOF]
 */
