...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "getEquationOfStateParameters",                       /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void getEquationOfStateParameters_atexit(void)
{
  ...
  getEquationOfStateParameters_xil_terminate();
  getEquationOfStateParameters_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_getEquationOfStateParameters_api.c
 *
 * [EOF]
 */
