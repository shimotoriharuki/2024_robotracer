...
/* Include Files */
#include "_coder_getEquationOfStateParameters_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name",
                emlrtMxCreateString("getEquationOfStateParameters"));
...
/*
 * File trailer for _coder_getEquationOfStateParameters_info.c
 *
 * [EOF]
 */
